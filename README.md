...
- [ ] **Неиспользуемый CSS:** ![medium] Удалить неиспользуемые CSS-селекторы.
    ...
    *Как:*
    > ⁃ ⚠️ Всегда проверяйте, не содержит ли код CSS-фреймворка, который вы хотите использовать, еще не включенный код сброса/нормализации стилей. Иногда вам может понадобиться не все, что находится внутри файла стилей для сброса/нормализации.
