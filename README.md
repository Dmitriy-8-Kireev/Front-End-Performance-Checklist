...
* ![High][high] означает, у этого пункта **высокий** приоритет. Вам не нужно избежать соблюдения этого правила и необходимо выполнить рекомендуемые исправления.
